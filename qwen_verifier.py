...
@dataclass
class Qwen2ProcessVerifierOutputWithPast(ModelOutput):
...
def Qwen2_forward(
    ...
    if self.config._attn_implementation == "flash_attention_2":
        ...
        # print("We are using SDPA, and output_attentions=True is not supported. Falling back to the manual implementation.")
...
class Qwen2ProcessVerifier(Qwen2ForCausalLM):
    def __init__(self, config):
        super().__init__(config)
        self.score = nn.Linear(config.hidden_size, 1, bias=False)
        self.model.forward = types.MethodType(Qwen2_forward, self.model)
    ...
    def forward(
    ...
    ) -> Union[Tuple, Qwen2ProcessVerifierOutputWithPast]:
        ...
        return Qwen2ProcessVerifierOutputWithPast(
            logits=logits,
